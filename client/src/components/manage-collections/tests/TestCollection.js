...
const TestCollection = () => { 
    ...
    const editHandler = (e) =>{
        ...
        FlashcardsDataService.updateCollection(data).then((response) => {
            console.log('success')
    ...
    const deleteHandler = (e) =>{
        FlashcardsDataService.deleteCollection(oldCollectionName).then((response) =>{        
        getCollections();
    ...
    const createHandler = (e) =>{
        ...
        FlashcardsDataService.createCollection(data).then((response) => {
            console.log('success')
            getCollections();
        }).catch((error) => console.log(error))
    }
  ...
  return (
        ...
        <>
            ...
            <label>Select a Collection</label>
                            ...
                            >
                            {collectionsToDisplay.map((collection,index) => { return (
                            <option key={index} 
            ...
            <input type="text" value={newCollectionName} onChange={(e)=>setNewCollectionName(e.target.value)}></input>
            ...
            <input type="text" value={createCollectionName} onChange={(e)=>setCreateCollectionName(e.target.value)}></input>
